...
">"             { return symbol(sym.MAIOR); } // Não implementado
"<"             { return symbol(sym.MENOR); } // Não implementado
">="            { return symbol(sym.MAIIG); } // Não implementado
"<="            { return symbol(sym.MENIG); } // Não implementado
"and"           { return symbol(sym.AND); } // Não implementado
"or"            { return symbol(sym.OR); } // Não implementado
"not"           { return symbol(sym.NOT); } // Não implementado
"while"         { return symbol(sym.WHILE); } // Não implementado
