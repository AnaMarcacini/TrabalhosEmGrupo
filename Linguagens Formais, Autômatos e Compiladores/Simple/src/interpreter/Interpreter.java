            ...
            if (ast instanceof CondOperator) {
                ...
                if (ast instanceof Operator) {
                    ...
                    switch (op) {
                        ...
                        case sym.AND:{
                            Boolean v1 = (Boolean) leftAST.getValue();
                            AST rightAST = operator.getRightAST();
                            Boolean v2 = (Boolean) rightAST.getValue();
                            operator.setValue(v1.booleanValue() && v2.booleanValue());
                            break;
                        }
                        case sym.NOT:{
                            Boolean v1 = (Boolean) leftAST.getValue();
                            operator.setValue(!v1.booleanValue());
                            break;
                        }
                        case sym.OR:{
                            Boolean v1 = (Boolean) leftAST.getValue();
